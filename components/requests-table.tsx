...
const allRequests = [
  ...
  // Reimbursements
  {
    ...
    name: "Robert Fox",
    role: "Medical Assistant",
    description: "Reimburse $37.95 (Uber)",
    hasComment: false,
    tooltip: {
  ...
  },
  {
    ...
    name: "Lisa Anderson",
    role: "Sales Manager",
    description: "Reimburse $125.50 (Marriott Hotel)",
    hasComment: true,
    comment: {
      author: "Tom Wilson",
  ...
  },
  {
    ...
    description: "Reimburse $89.25 (The Capital Grille)",
    hasComment: false,
    tooltip: {
      ...
      details: [
        ...
        { label: "Category", value: "Meals" },
        { label: "Reason", value: "Client dinner" },
      ],
    },
  },
  // HR Management
                    ...
                    <div className="flex items-center justify-between gap-2 min-w-0">
                      ...
                      <Tooltip delayDuration={200}>
                        <TooltipTrigger asChild>
                          <div className="flex items-center text-[12px] leading-4 text-gray-600 cursor-pointer hover:text-gray-900 shrink-0 border border-gray-300 rounded-full" style={{ height: '16px', paddingLeft: '6px', paddingRight: '6px' }}>
